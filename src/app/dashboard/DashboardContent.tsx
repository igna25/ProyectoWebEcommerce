    ...
    <div className="mx-auto max-w-7xl px-4" id="discover">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 mb-6 px-2 sm:px-0 w-full">
        ...
        <select
          ...
          className="w-full sm:w-auto rounded-xl border border-gray-200 bg-gray-50 py-2.5 px-3.5 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#004AAD] focus:border-transparent transition"
        >
